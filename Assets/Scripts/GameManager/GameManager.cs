...
namespace GameManager
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            winEvent.AddListener(() =>
                                 {
                                     if (unlockLevel != null)
                                     {
                                         DataTransfer.GetDataTransfer.levelRevealedList[unlockLevel] = true;
            ...
            winEvent.AddListener(() =>
                                 {
                                     DataTransfer.GetDataTransfer.characterRevealedList[unlockCharacter] = true;
                                 });
        }

        private bool _isEventHasBeenLaunched = false;
        /// <summary>
        /// 我方胜利
        /// </summary>
