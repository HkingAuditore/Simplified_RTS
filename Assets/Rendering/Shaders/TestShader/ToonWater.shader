Shader "Unlit/ToonWater"
{
    Properties
    {
        ...
        _MainLightCol("Light Color", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                return LightingPhysicallyBasedCustom(brdfData, light.color, light.direction, light.distanceAttenuation * light.shadowAttenuation, normalWS, viewDirectionWS);
            }
            
            half4 UniversalFragPBR(InputData inputData, half3 albedo, half metallic, half3 specular,half smoothness, half occlusion, half3 emission, half alpha)
            {
                BRDFData brdfData;
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                half4 color = UniversalFragPBR(inputData, surfaceData.albedo, surfaceData.metallic, surfaceData.specular, surfaceData.smoothness, surfaceData.occlusion, surfaceData.emission, surfaceData.alpha);
